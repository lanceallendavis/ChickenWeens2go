...
$sql3 = "Select * from  orders where accepted_at >= (CURDATE() - INTERVAL 1 MONTH )";
$result3 = mysqli_query($db_connect,$sql3);
$row3 = mysqli_num_rows($result3);

$sql4 = "Select SUM(stock_deduction) as stocks from  order_details ";
        ...
        <div class="card-body">
          <div class="stat-widget-one">
            ...
            <div class="stat-content dib">
              ...
              <div class="stat-digit"><?php echo $row4['stocks']; ?></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="stat-widget-one">
            ...
            <div class="stat-content dib">
              <div class="stat-text">Total Orders (30 days)</div>
