...
$display_cart_query = "SELECT user.address as user_address, user.city as user_city, cart.ID, user.ID as user_ID, prod.ID as product_ID, prod.name as product_name,
