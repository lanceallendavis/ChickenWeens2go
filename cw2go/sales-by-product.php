...
<aside id="left-panel" class="left-panel">
  <nav class="navbar navbar-expand-sm navbar-default">
    ...
    <div id="right-panel" class="right-panel">
        <h1 class="text-center" style="font-family: 'Black Han Sans', sans-serif;letter-spacing: 6px;color: rgb(248,157,19);background-color: #1b120f; height: 80px; padding-top: 20px; font-size: 28px;">Sales by Product</h1>
        ...
        <div class="col-md-12">
          ...
          <th style="color: #1b120f">Quantity Sold</th>
          <th style="color: #1b120f">Total</th>

                        </tr>
                <tbody>
               <?php
          require_once('./includes/sales-by-product.inc.php');
          while($row = mysqli_fetch_array($sales_product_results, MYSQLI_ASSOC)){
          echo '<tr>';
