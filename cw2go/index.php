  ...
  <section id="portfolio" class="p-0">
    <div class="container-fluid p-0">
      <div class="row no-gutters popup-gallery">
        ...
        <div class="col-sm-6 col-lg-4"><a href="userasset/img/fullsize/2.jpg" class="portfolio-box"><img class="img-fluid" src="userasset/img/ck2.jpg"><div class="portfolio-box-caption"><div class="portfolio-box-caption-content"><div class="project-category text-faded"><span>Category</span></div><div class="project-name"><span>Project Name</span></div></div></div></a></div>
        <div class="col-sm-6 col-lg-4"><a href="userasset/img/fullsize/3.jpg" class="portfolio-box"><img class="img-fluid" src="userasset/img/ck3.jpg"><div class="portfolio-box-caption"><div class="portfolio-box-caption-content"><div class="project-category text-faded"><span>Category</span></div><div class="project-name"><span>Project Name</span></div></div></div></a></div>
        <div class="col-sm-6 col-lg-4"><a href="userasset/img/fullsize/4.jpg" class="portfolio-box"><img class="img-fluid" src="userasset/img/ck4.jpg"><div class="portfolio-box-caption"><div class="portfolio-box-caption-content"><div class="project-category text-faded"><span>Category</span></div><div class="project-name"><span>Project Name</span></div></div></div></a></div>
        <div class="col-sm-6 col-lg-4"><a href="userasset/img/fullsize/5.jpg" class="portfolio-box"><img class="img-fluid" src="userasset/img/ck5.jpg"><div class="portfolio-box-caption"><div class="portfolio-box-caption-content"><div class="project-category text-faded"><span>Category</span></div><div class="project-name"><span>Project Name</span></div></div></div></a></div>
        <div class="col-sm-6 col-lg-4"><a href="userasset/img/fullsize/6.jpg" class="portfolio-box"><img class="img-fluid" src="userasset/img/ck6.jpg"><div class="portfolio-box-caption"><div class="portfolio-box-caption-content"><div class="project-category text-faded"><span>Category</span></div><div class="project-name"><span>Project Name</span></div></div></div></a></div>
      </div>
    </div>
  </section>
