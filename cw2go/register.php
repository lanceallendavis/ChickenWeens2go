      ...
      <div class="col-10 col-sm-8 col-md-6 col-lg-6 offset-1 offset-sm-2 offset-md-3 offset-lg-0 align-self-center d-lg-flex align-items-lg-center align-self-lg-stretch bg-white p-5 rounded rounded-lg-0 my-5 my-lg-0" id="login-block">
        <div class="m-auto w-lg-75 w-xl-50">
          <form action="register.php" method="post" enctype="multipart/form-data" style="padding-top: 127px;" >
            ...
            <div class="form-group"><label class="text-secondary" style="font-family: Lato, sans-serif;">First Name</label><input class="form-control" type="text" pattern="[A-Za-z]+" name="firstName" style="font-family: Lato, sans-serif;" value="<?php if (isset($_POST['firstName'])) echo $_POST['firstName']; ?>" required></div>
            <div class="form-group" style="font-family: Lato, sans-serif;"><label class="text-secondary">Last Name</label><input class="form-control" type="text" pattern="[A-Za-z]+" name="lastName" style="font-family: Lato, sans-serif;" value="<?php if (isset($_POST['lastName'])) echo $_POST['lastName']; ?>" required></div>
